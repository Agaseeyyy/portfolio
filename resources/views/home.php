...
<div class="relative z-10 min-h-screen overflow-x-hidden">
  ...
  <header id="home" class="flex flex-col items-center justify-center min-h-screen gap-8 px-6 max-w-8xl lg:flex-row lg:gap-16 xl:gap-20">
    ...
    <div class="relative w-full max-w-xl p-6 border shadow-2xl opacity-0 lg:w-auto lg:max-w-2xl xl:max-w-3xl rounded-2xl backdrop-blur-md bg-white/10 border-white/20 animate-slide-in-left">
      <!-- Glass shine effect -->
      ...
      <div class="relative z-10 space-y-5">
        ...
        <div class="flex flex-row gap-4 mt-6 opacity-0 max-sm:justify-center lg:gap-6 animate-fade-in-up animation-delay-1000">
          <a href="#projects" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white transition-all duration-300 border rounded-lg shadow-lg bg-gradient-to-r from-pink-500/90 to-rose-600/90 backdrop-blur-sm border-white/20 hover:from-pink-600 hover:to-rose-700 hover:scale-105 hover:shadow-xl">
          ...
          <a href="#portfolio" class="inline-flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white transition-all duration-300 border rounded-lg shadow-lg border-pink-500/50 backdrop-blur-sm hover:from-pink-600/30 hover:to-rose-700/30 hover:scale-105 hover:shadow-xl bg-gradient-to-r from-pink-500/20 to-rose-600/20">
        ...
        <!-- Social Media Icons -->
        <div class="flex gap-6 pt-8 mt-8 border-t opacity-0 border-white/20 animate-scale-in animation-delay-1500">
          <!-- Github -->
          <a href="https://github.com/agaseeyyy" target="_blank" 
            ...
            <svg class="w-6 h-6 text-white lg:w-5 lg:h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512">
          ...
          <a href="https://linkedin.com/in/agassi-bustarga" target="_blank" 
             class="p-3 transition-all duration-200 border rounded-full border-white/20 backdrop-blur-sm bg-white/10 hover:bg-pink-500/20 hover:border-pink-500/50 hover:scale-110 hover:-rotate-12">
            <svg class="w-6 h-6 text-white lg:w-5 lg:h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 448 512">
          ...
          <a href="mailto:bustargaagassi1018@gmail.com" target="_blank" 
             class="p-3 transition-all duration-200 border rounded-full border-white/20 backdrop-blur-sm bg-white/10 hover:bg-pink-500/20 hover:border-pink-500/50 hover:scale-110 hover:-rotate-12">
            <svg class="w-6 h-6 text-white lg:w-5 lg:h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 488 512">
    ...
    <div class="relative flex items-center justify-center opacity-0 animate-slide-in-right animation-delay-500">
      <!-- Orbit Container that can extend beyond parent -->
