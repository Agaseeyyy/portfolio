...
<div class="admin-card">
    <div class="admin-card-header">
        <h3 class="text-lg font-semibold text-white">All Certifications</h3>
...
<dialog id="certModal" class="modal">
    <div class="admin-modal-box max-w-md">
        <form id="certForm" method="POST" enctype="multipart/form-data">
            ...
            <h3 class="admin-modal-title" id="modalTitle">Add New Certification</h3>
            
            <div class="space-y-4">
                <!-- Current Image Preview (for edit) -->
                <div id="currentImagePreview" class="hidden">
                    <label class="label">
                        <span class="text-gray-300 label-text">Current Image</span>
                    </label>
                ...
                <div class="form-control">
                    <label class="label">
                        <span class="text-gray-300 label-text" id="imageLabel">Certification Image</span>
                        <span class="text-pink-400 label-text-alt" id="imageRequired">Required</span>
                    </label>
                    <input type="file" name="image" id="imageInput" accept="image/*" class="admin-file-input">
                    <label class="label">
                        <span class="text-gray-500 label-text-alt">Recommended: High resolution image of your certificate</span>
                    </label>
                </div>
            </div>
...
<dialog id="imageViewerModal" class="modal">
    <div class="modal-box max-w-4xl p-2 bg-base-200">
