...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h3 class="text-lg font-semibold text-white">Update Contact Information</h3>
            ...
            <div class="space-y-6">
                ...
                <div class="p-4 rounded-lg bg-base-300">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="text-gray-300 label-text">Email Address</span>
                            ...
                            <div class="relative">
                                ...
                                <input type="email" name="email" value="<?= $contact['email'] ?? '' ?>" 
                                       ...
                                       class="admin-input pl-10" required>
                            </div>
                        </div>
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="text-gray-300 label-text">Address / Location</span>
                                <span class="text-pink-400 label-text-alt">Required</span>
                            </label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                ...
                <div class="p-4 rounded-lg bg-base-300">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="text-gray-300 label-text">GitHub Profile</span>
                            </label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="text-gray-300 label-text">LinkedIn Profile</span>
                            </label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-control">
                            <label class="label">
                                <span class="text-gray-300 label-text">Instagram Profile</span>
                            </label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-500">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
