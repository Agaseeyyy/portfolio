...
<dialog id="techModal" class="modal">
    <div class="modal-box !max-w-md">
        <form id="techForm" method="POST" enctype="multipart/form-data">
            ...
            <h3 class="modal-title" id="modalTitle">Add New Technology</h3>

            <fieldset class="fieldset">
                <!-- Tech Name -->
                <label class="modal-label">Technology Name <span class="text-pink-400 text-xs">Required</span></label>
                <input type="text" name="tech_name" id="techName" class="input" placeholder="e.g., React, PHP, Python" required>

                <!-- Category -->
                <label class="modal-label">Category <span class="text-pink-400 text-xs">Required</span></label>
                <select name="category" id="techCategory" class="select" required>
