...
<div class="grid grid-cols-1 gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    ...
    <div class="admin-stat">
        <div class="flex items-center justify-between">
            <div>
                <p class="admin-stat-label">Total Projects</p>
                <p class="admin-stat-value"><?= $projectCount ?? 0 ?></p>
            </div>
            <div class="flex items-center justify-center w-12 h-12 rounded-lg bg-pink-500/20">
        ...
        <div class="mt-4">
            <a href="<?= base_url('admin/projects') ?>" class="text-sm text-pink-400 hover:text-pink-300">Manage Projects →</a>
        </div>
    </div>
    ...
    <div class="admin-stat">
        <div class="flex items-center justify-between">
            <div>
                <p class="admin-stat-label">Tech Stack</p>
                <p class="admin-stat-value"><?= $techCount ?? 0 ?></p>
            </div>
            <div class="flex items-center justify-center w-12 h-12 rounded-lg bg-blue-500/20">
        ...
        <div class="mt-4">
            <a href="<?= base_url('admin/techstack') ?>" class="text-sm text-blue-400 hover:text-blue-300">Manage Tech →</a>
        </div>
    </div>
    ...
    <div class="admin-stat">
        <div class="flex items-center justify-between">
            <div>
                <p class="admin-stat-label">Certifications</p>
                <p class="admin-stat-value"><?= $certCount ?? 0 ?></p>
            </div>
            <div class="flex items-center justify-center w-12 h-12 rounded-lg bg-green-500/20">
        ...
        <div class="mt-4">
            <a href="<?= base_url('admin/certifications') ?>" class="text-sm text-green-400 hover:text-green-300">Manage Certs →</a>
        </div>
    </div>
    ...
    <div class="admin-stat">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="admin-stat-value"><?= $serviceCount ?? 0 ?></p>
            </div>
        ...
        <div class="mt-4">
            <a href="<?= base_url('admin/services') ?>" class="text-sm text-purple-400 hover:text-purple-300">Manage Services →</a>
        </div>
    </div>
</div>
...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
    ...
    <div class="admin-card">
        <div class="admin-card-header">
            <h3 class="text-lg font-semibold text-white">Content Sections</h3>
        </div>
        <div class="space-y-4">
