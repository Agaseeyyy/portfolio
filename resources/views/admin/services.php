...
<div class="admin-card">
    <div class="admin-card-header">
        <h3 class="text-lg font-semibold text-white">All Services</h3>
...
<dialog id="serviceModal" class="modal">
    <div class="admin-modal-box max-w-2xl">
        <form id="serviceForm" method="POST" enctype="multipart/form-data">
            ...
            <h3 class="admin-modal-title" id="modalTitle">Add New Service</h3>
            
            <div class="space-y-4">
                <!-- Service Title -->
                <div class="form-control">
                    <label class="label"><span class="text-gray-300 label-text">Service Title</span></label>
                    <input type="text" name="title" id="serviceTitle" class="admin-input" placeholder="e.g., Web Development" required>
                </div>

                <!-- Service Icon -->
                <div class="form-control">
                    <label class="label"><span class="text-gray-300 label-text">Icon</span></label>
                ...
                <!-- Short Description -->
                <div class="form-control">
                    <label class="label"><span class="text-gray-300 label-text">Short Description</span></label>
                    <textarea id="shortInfo" rows="2" class="admin-textarea" placeholder="Brief overview of this service..."></textarea>
                </div>

                <!-- Features Builder -->
                <div class="form-control">
                    <label class="label">
                        <span class="text-gray-300 label-text">Features (Bullet Points)</span>
                    ...
                    <p class="mt-2 text-xs text-gray-500">Add bullet points that describe what this service includes</p>
                </div>
            </div>

            <div class="modal-action">
                <button type="button" onclick="closeModal()" class="admin-btn-secondary">Cancel</button>
                <button type="submit" class="admin-btn-primary"><span id="submitBtnText">Add Service</span></button>
            </div>
        </form>
    </div>
...
<script>
    ...
    function updateFeature(index, value) { features[index] = value; }
    function removeFeature(index) { features.splice(index, 1); renderFeatures(); }
