...
<header id="home" class="relative pt-24 pb-12 overflow-hidden flex flex-col items-center justify-center min-h-[85vh]">
  <!-- Hero Sky Pixel Banner - Full height with smooth gradient fade & 8-bit tree silhouette shadow layer -->
  <div class="absolute top-0 left-0 right-0 h-[720px] lg:h-[800px] z-0 overflow-hidden pointer-events-none opacity-90">
    ...
    <!-- 8-Bit Pixel Tree Silhouette Shadows Horizon Line -->
    <div class="absolute bottom-0 left-0 right-0 h-28 lg:h-36 z-1 overflow-hidden pointer-events-none">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-full fill-[#060918] opacity-95">
        <path d="
          ...
          L 1080,90 L 1095,65 L 1110,90 L 1110,75 L 1125,45 L 1140,75 L 1140,60 L 1155,28 L 1170,60 L 1170,80 L 1185,55 L 1200,80 L 1200,120 Z
