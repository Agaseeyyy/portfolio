...
<main class="min-h-screen px-6 py-20 max-lg:py-32">
  <div class="max-w-6xl mx-auto">
    ...
    <div class="relative mb-12 overflow-hidden border shadow-2xl rounded-2xl bg-gray-800/30 border-gray-700/50">
      ...
      <!-- Gradient Overlay -->
      <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 to-transparent max-lg:hidden"></div>

      <!-- Project Title Overlay -->
      <div class="absolute bottom-0 left-0 right-0 p-8 max-lg:static max-lg:p-4 max-lg:pt-6">
        <h1 class="mb-3 text-4xl font-bold text-white xl:text-5xl max-lg:text-2xl"><?= htmlspecialchars($project['project_name'] ?? '') ?></h1>

        <div class="flex flex-wrap items-center gap-4 text-sm max-lg:gap-2">
