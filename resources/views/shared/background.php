<!-- Starry Pixel Night Background & Dark 8-Bit Tree Shadow Silhouette Canopy -->
<div class="starry-bg absolute inset-0 pointer-events-none overflow-hidden z-0">
  ...
  <!-- 8-Bit Pixel Tree Shadow Canopy (On solid dark background - zero PNG dependence) -->
  <div class="absolute bottom-0 left-0 right-0 h-44 lg:h-64 pointer-events-none overflow-hidden opacity-90">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 140" preserveAspectRatio="none" class="w-full h-full fill-[#050816]">
      <path d="
